...
import { FacturasClientesResponse, FacturaCliente, FacturasClientesAPIResponse } from '@/types/cajaDiaria';
    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <p className="text-gray-600">Cargando facturas cobradas...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      {facturas.length === 0 ? (
        <div className="card p-8 text-center">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">No hay facturas cobradas</h3>
          <p className="text-gray-500">No se encontraron facturas con estado de cobro completado.</p>
        </div>
      ) : (
        <>
